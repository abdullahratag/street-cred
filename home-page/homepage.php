    ...
    <head>
        ...
        <link rel="stylesheet" href="../submit-page/submit.css">
    ...
    <body>
        ...
        <section class="hero">
            <div class="container hero-grid">
                ...
                <div class="hero-image">
                    <img src="Images/DowntownZamboanga.jpg">
                </div>
            </div>
        </section>
        ...
        <section class="how-it-works">
            <div class="container">
                ...
                <div class="workflow-box citizen-box">
                    <h3><i class="fas fa-check-circle"></i> For Citizens</h3>
                    <div class="step-grid">
                        <div class="step-card">
                            <span>Step 1</span>
                ...
                <div class="workflow-box official-box">
                    <h3><i class="fas fa-city"></i> For Officials</h3>
                    <div class="step-grid">
        ...
        <section class="resolved-news">
        <div class="container">
            <h2>Recent Reports</h2>
                <p class="section-desc">Stay informed on the latest infrastructure updates across Zamboanga City. 
            From waste collection in Tetuan to utility repairs in Santa Maria, track 
            how our community is working together to resolve local issues.
                </p>
            
            <div class="news-grid">
                <!-- News Card 1: Resolved Example -->
                <div class="report-card">
                    ...
                    <div class="report-content">
                        ...
                        <p class="location">Don Alfaro St, Tetuan, Zamboanga City</p>
                    </div>
                </div>

                <!-- News Card 2: Submitted Example -->
                <div class="report-card">
                    <div class="report-img">
                    ...
                    <div class="report-content">
                        ...
                        <p class="location">Gov. Ramos Ave, Santa Maria, Zamboanga City</p>
                    </div>
                </div>
            </div>
        </div>
